...
install_reqs = ['Theano>=0.7.0', 'funcsigs>=0.4', 'matplotlib>=1.4.3', 'mock>=1.1.2', 'numpy>=1.9.2', 'pandas>=0.16.2', 'patsy>=0.3.0', 'pbr>=1.3.0', 'pyfolio>=0.1.beta', 'pymc3>=3.0', 'pyparsing>=2.0.3', 'python-dateutil>=2.4.2', 'pytz>=2015.4', 'scikit-learn>=0.16.1', 'scipy>=0.15.1', 'seaborn>=0.6.0', 'six>=1.9.0', 'statsmodels>=0.6.1', 'wsgiref>=0.1.2']
